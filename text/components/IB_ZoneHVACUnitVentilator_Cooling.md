## IB_ZoneHVACUnitVentilator_Cooling

![](../../images/components/IB_ZoneHVACUnitVentilator_Cooling.png)
...
#### Inputs
* ##### coilC 
Cooling coil to provide cooling source. It has to be CoilCoolingWater. 
* ##### fan 
