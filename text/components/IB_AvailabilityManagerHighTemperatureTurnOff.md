...
![](../../images/components/IB_AvailabilityManagerHighTemperatureTurnOff.png)
...
#### Inputs
* ##### probe [Required]
Add a IB_NodeProbe to a loop first, and then connect the probe to here for availability manager to use. 
* ##### params 
